...
public class MyRDFIndex extends Configured implements Tool
{
    private static final Logger LOG = Logger
            .getLogger(MyRDFIndex.class);
    ...
    public int run(String[] args) throws Exception
    {
        ...
        RDFIndex.setJarByClass(MyRDFIndex.class);
    ...
    {
        ToolRunner.run(new MyRDFIndex(), args);
    }
}
